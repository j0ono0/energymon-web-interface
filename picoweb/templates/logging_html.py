# Autogenerated file
def render(log_ts, log_aws, active_logger):
    yield """
...
<div class=\"ui__header\">
                            ...
                            <p>
                                <label>
                                    ...
                                    >
                                        ...
                                        <option"""
    if log_ts.name == active_logger:
        yield """ selected"""
    yield """>"""
    yield str(log_ts.name)
    yield """</option>
                                        <option"""
    if log_aws.name == active_logger:
        yield """ selected"""
    yield """>"""
    yield str(log_aws.name)
    yield """</option>
                                    </select>
                                </label>
                            </p>
    ...
    yield str(log_ts.key)
    yield """\">
                                </label>
                            </p>
                        </fieldset>
                        <fieldset  """
    if active_logger != 'AWS IoT':
        yield """ v-cloak """
    yield """ v-if=\"service=='AWS IoT'\">
                            <h3>Amazon web service, IoT</h3>
                            <p>
                                <label>
                                    Certificate <input type=\"file\" value=\""""
    yield str(log_aws.cert)
    yield """\">
                                </label>
                            </p>
                            <p>
                                <label>
                                    Private key <input type=\"file\" value=\""""
    yield str(log_aws.key)
    yield """\">
                                </label>
                            </p>
                            <p>
                                <label>
                                    Endpoint subdomain <input type=\"text\" value=\""""
    yield str(log_aws.subdomain)
    yield """\">
                                </label>
                            </p>
                            <p>
                                <label>
                                    Endpoint region <input type=\"text\" value=\""""
    yield str(log_aws.region)
    yield """\">
                                </label>
                            </p>
                        </fieldset>
