# Autogenerated file
def render(config, version, latest):
    yield """
...
<div class=\"ui__header\">
    ...
    yield from render3('Device configuration')
    yield """
                <div class=\"ui__body\">
    ...
    for circuit in config:
        ...
        yield """\">
                        ...
                        """
    yield """
                        <p><a class=\"button\" href=\"/\">Cancel</a> <button>Save</button></p>
                    </form>
                </div>
            </div>
        </div>
...
<div class=\"ui__header\">
    ...
    yield from render4('Firmware')
    yield """
                <div class=\"ui__body\">
                    <p>Installed firmware version: """
    yield str(version)
    yield """</p>
                    <p>Latest stable firmware version: """
    yield str(latest)
    yield """
