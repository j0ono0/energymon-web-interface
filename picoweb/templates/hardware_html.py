...
# Autogenerated file
        def render3(*a, **d):
            ...
            yield str(alert.type)
            yield """\">
    <div>
        """
            yield str(alert.message)
            yield """
    </div>
</div>"""
        yield from render3()
...
<div class=\"ui__header\">
    ...
    yield from render4('Device configuration')
    yield """
                <div class=\"ui__body\">
                    <div class=\"content\">
                        <p>Some explaination needed? ...</p>
                    </div>
                    <form method=\"post\" class=\"form form__device\">
                        """
    for circuit in config:
        yield """
                        <fieldset>
                                <h2>"""
        yield str(circuit['Name'])
        yield """</h2>
                                <div class=\"grid-4\">
                                    <p>
                                        <label>
                                        CRC1 <input name=\""""
        yield str(circuit['Name'])
        yield """_CRC1\" type=\"text\" value=\""""
        yield str(circuit['CRC1'])
        yield """\">
                                        </label>
                                    </p>
                                    <p>
                                        ...
                                        CRC2 <input name=\""""
        yield str(circuit['Name'])
        yield """_CRC2\" type=\"text\" value=\""""
        yield str(circuit['CRC2'])
        yield """\">
                                        </label>
                                    </p>
                                    <p>
                                        ...
                                        Gain <input name=\""""
        yield str(circuit['Name'])
        yield """_Gain\" type=\"text\" value=\""""
        yield str(circuit['Gain'])
        yield """\">
                                        </label>
                                    </p>
                                    <p>
                                        ...
                                        U-Gain <input name=\""""
        yield str(circuit['Name'])
        yield """_Ugain\" type=\"text\" value=\""""
        yield str(circuit['Ugain'])
        yield """\">
                                        </label>
                                    </p>
                                </div>
                        ...
                        """
    yield """
                        <p><a class=\"button\" href=\"/\">Cancel</a> <button type=\"submit\" name=\"submit\">Save</button></p>
                    </form>
                </div>
            </div>
        </div>
